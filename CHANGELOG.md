...
- The crate-level documentation is now the same as [`README.md`](https://github.com/toku-sa-n/accessor/blob/main/README.md) ([#25](https://github.com/toku-sa-n/accessor/pull/25)).
